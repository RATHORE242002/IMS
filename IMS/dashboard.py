...
class RATHORE:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Developed By Anurag Rathore")
        ...
        lbl_menu=Label(LeftMenu,text="Menu",font=("timew new roman",20),bg="#009688").pack(side=TOP,fill=X)
