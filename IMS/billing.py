...
class BillClass:
    def __init__(self,root):
        ...
        #====clock=====
        self.lbl_clock=Label (self.root,text="Welecome to Inventory Management System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15),bg ="#4d636d",fg="white")
       ...
       #=========CustomerFrame=============
        ...
        self.cartTitle=Label(cart_Frame,text="Card \t Total Product :[0]" ,font=("goudy old style",15),bg="lightgray")
    ...
    #========================billing area====================================
        ...
        #=====================Footer==============
        footer=Label(self.root,text="IMS- Inventory Management System | Developed by Anurag Rathore",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.show()
...
#================== All Function=======================================
    ...
    def Generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            messagebox.showerror("Error"," Please add the product in cart list. ",parent=self.root)        
        else:
            ##-----Bill Top--------
            self.bill_top()
            ##-----Bill Middle--------
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ - Inventory
\tPhone no. - 98527xxxxx , Delhi-110008
{str("="*47)}
